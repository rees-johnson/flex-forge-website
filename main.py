...
if __name__ == "__main__":
        ...
        with st.popover("Checkout"):
            ...
            with yes_col:
                ...
                with st.popover("Yes"):
                    ...
                    # TODO: Send an email to business account. Manually handle from there.
    ...
    with main_column:
        st.markdown("## Welcome to the FlexForge comunity!")
        ...
        with products_container:
            ...
            for product in st.session_state.products:
                ...
                with col1:
                    st.image(product["image_path"], width=300)
                with col2:
                    if st.button(label=f"View {product['name']}"):
                        st.session_state.product_on_display = i
                i = i + 1
            
        if st.session_state.product_on_display is not None:
            display_product_info(info_container, st.session_state.product_on_display)
